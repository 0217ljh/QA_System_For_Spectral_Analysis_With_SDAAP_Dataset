...
class Generate():
    ...
    def predcit_circulate(self, 
        ...
        if self.model:
            self.model.eval()
            columns_to_keep = ['Instruction', 'Input','Output','input_ids']  # Only keep this special columns.
        else:
            columns_to_keep = ['Instruction','Input', 'Output','template_instruction']
